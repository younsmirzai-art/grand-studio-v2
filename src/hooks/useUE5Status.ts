...
export function useUE5Status(projectId: string | null) {
  const { setUE5Commands, addUE5Command, updateUE5Command, setRelayConnected } = useProjectStore();
  ...
  }, [projectId, setUE5Commands, addUE5Command, updateUE5Command, setRelayConnected]);
}
